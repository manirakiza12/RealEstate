...
import com.example.realestate.databinding.ActivityPayStackBinding;
...
public class PayStackActivity extends AppCompatActivity implements OnCreditCardStateChanged {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StatusBar.initLatestScreen(PayStackActivity.this);
        viewPayStackBinding = ActivityPayStackBinding.inflate(getLayoutInflater());
        setContentView(viewPayStackBinding.getRoot());
        PaystackSdk.initialize(this);

        method = new Method(PayStackActivity.this);

        viewPayStackBinding.toolbarMain.tvName.setText(getString(R.string.payment_paystack));
        viewPayStackBinding.toolbarMain.fabBack.setOnClickListener(v -> onBackPressed());
        ...
        viewPayStackBinding.btnPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (method.isNetworkAvailable()) {
                    ...
                    Toast.makeText(PayStackActivity.this, getString(R.string.no_internet_msg), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void performCharge(String email) {
        ...
        PaystackSdk.chargeCard(PayStackActivity.this, charge, new Paystack.TransactionCallback() {
            ...
            public void onSuccess(Transaction transaction) {
                ...
                if (method.isNetworkAvailable()) {
                    new com.elite.paymentmethod.Transaction(PayStackActivity.this)
                            .purchasedItem(planId, method.getUserId(), transaction.getReference(), planGateway);
                } else {
